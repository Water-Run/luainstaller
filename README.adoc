...
The required CI gate exercises these native runner classes. Additional Linux
distributions and macOS systems are used as supplemental compatibility checks,
not as release prerequisites:
