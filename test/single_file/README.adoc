...
This directory contains small, independent, single-file Lua programs.
They are intended to be the first smoke tests for `luainstaller` because
they do not need module resolution beyond Lua's standard libraries.
...
The catalog is arranged like a compact freshman/sophomore programming
course. Every file is standalone and should remain understandable
without opening any other source file.
