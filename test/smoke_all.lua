...
print(result.executable)
    ...
    assert_contains(windows_script, "tools/test-lua-versions.ps1")
    ...
    assert_contains(test_readme, "tools/test-lua-versions.ps1")
    ...
    assert_contains(testing_guide, "tools/test-lua-versions.ps1")
