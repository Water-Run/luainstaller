...
This sample is a complete terminal student management system. It is
larger than the `single_file` samples and is meant to exercise
normal multi-file Lua packaging plus a LuaRocks dependency.
